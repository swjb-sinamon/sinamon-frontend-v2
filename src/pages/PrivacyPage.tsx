    ...
    <>
      ...
      <Container>
        ...
        <div>
          ...
          <p>
            &lt;수정과&gt;(‘snm.itsw.info’이하 ‘수정과’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의
        ...
        <div>
          ...
          <p>
            ① &lt;수정과&gt;(‘snm.itsw.info’이하 ‘수정과’) 은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보
            보유․이용기간 또는 법령에 따른 개인정보 보유․이용기간 내에서 개인정보를 처리․보유합니다. <br />② 구체적인
        ...
        <div>
          ...
          <p>① 정보주체는 수정과 에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.</p>
          <p>
            1. 개인정보 열람요구 <br />
        ...
        <div>
          ...
          <p>
            1. &lt;서비스 이용&gt; <br />- 필수항목: 아이디, 비밀번호, 이름, 학년, 반, 번호, 서비스 이용 기록, IP,
            User-Agent, 쿠키
          </p>
        </div>
        <Gap gap={12} />
        ...
        <div>
          ...
          <p>
            ① 수정과 은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의
          ...
          <p>
            - 파기기한 <br />
            이용자의 개인정보는 개인정보의 보유기간이 경과된 경우에는 보유기간의 종료일로부터 7일 이내에, 개인정보의
            처리 목적 달성, 해당 서비스의 폐지, 사업의 종료 등 그 개인정보가 불필요하게 되었을 때에는 개인정보의 처리가
            불필요한 것으로 인정되는 날로부터 7일 이내에 그 개인정보를 파기합니다.
          </p>
        </div>
        <Gap gap={12} />
        ...
        <div>
          ...
          <p>
            ① 수정과 은(는) 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠기(cookie)’를
            사용합니다.
          </p>
          <p>
            ② 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 컴퓨터 브라우저에게 보내는 소량의 정보이며
            이용자들의 PC 컴퓨터내의 하드디스크에 저장되기도 합니다. 가. 쿠키의 사용 목적 : 이용자가 방문한 각 서비스와
            웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보
            제공을 위해 사용됩니다. 나. 쿠키의 설치•운영 및 거부 : 웹브라우저 상단의 도구&gt;인터넷 옵션&gt;개인정보
            메뉴의 옵션 설정을 통해 쿠키 저장을 거부 할 수 있습니다. 다. 쿠키 저장을 거부할 경우 맞춤형 서비스 이용에
            어려움이 발생할 수 있습니다.
          </p>
          <p>
            ③ 수정과 은(는) 더 나은 서비스 제공 및 통계를 위해 로그 분석툴인 Google Analytics(구글 애널리틱스) 을(를)
            사용합니다. 단, 개인을 식별할 수 없는 비식별정보만 수집합니다.
          </p>
          <p>
            ④ 필요한 경우 구글 애널리틱스 사용을 거부할 수 있습니다. 브라우저 쿠키 차단 또는 차단 부가기능을
            설치해주세요.{' '}
        ...
        <div>
          ...
          <p>
            수정과는 서비스 향상을 위해서 아래와 같이 개인정보를 위탁하고 있으며, 관계 법령에 따른 위탁계약 시
        ...
        <div>
          ...
          <p>
            ① 수정과 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및
            피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
          </p>
          <p>- 관련 내용은 링크를 통해 확인할 수 있습니다.</p>
          <p>
            -{' '}
            <a href="http://swjb.hs.kr/pra_view?mode=pra&layout=Y" target="_blank" rel="noreferrer">
              http://swjb.hs.kr/pra_view?mode=pra&layout=Y
            </a>
          </p>
        </div>
        <Gap gap={12} />
        ...
        <div>
          ...
          <p>
            ① 수정과 은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를
            하고 있습니다.
          </p>
          <p>
            1. 개인정보의 암호화 <br />
