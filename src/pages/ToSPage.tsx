    ...
    <>
      ...
      <Container>
        ...
        <div>
          ...
          <p>
            본 약관은 IT소프트웨어과 인트라넷 프로젝트, 수정과(이하 "수정과")를 이용함에 있어 수정과와 사용자 간의 권리,
        ...
        <div>
          ...
          <p>1. "사용자"는 본 약관을 동의하고 수정과에서 제공하는 서비스를 이용하는 사람을 의미합니다.</p>
        </div>
        ...
        <div>
          ...
          <p>
            1. 수정과 서비스 제공을 위해 개인정보를 받아 회원가입하고 있으며 회원가입 시 별도의 개인정보처리방침을
            동의하게 됩니다.
            <br />
        ...
        <div>
          ...
          <p>
            ...
            - 기타 학과에서 진행하는 행사
            <br />
            2. 수정과가 제공하는 서비스는 변경될 수 있으며 모든 서비스는 학교 행사와 연관되어 있습니다.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            - 수정과는 관련 법령을 준수하고 이 약관에서 금지하거나 미풍양속에 반하는 행위를 하지 않습니다.
            <br />
            - 안정적인 서비스를 제공하기 위하여 최선의 노력을 다합니다.
            <br />
            - 해결 불가능한 결함 및 장애 등 부득이한 사유가 없는 한 수리 또는 복구하도록 최선의 노력을 다합니다.
            <br />
            - 수정과는 사용자의 개인정보를 본인의 승낙 없이 제3자에게 누설, 배포하지 않고 이를 보호하기 위하여
            노력합니다.
            <br />- 사용자의 개인정보보호 및 사용에 대해서는 관련 법령 및 개인정보처리방침에 따릅니다.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            1. 사용자가 이용약관을 위반함으로 인하여 수정과가 사용자 또는 제3자에 대하여 책임을 부담하게 되고, 이로써
            수정과에게 손해가 발생하게 되는 경우, 사용자는 수정과에게 발생하는 모든 손해를 배상하여야 하며, 수정과의
            책임이 면제됩니다.
            <br />
            2. 수정과는 서비스를 제공할 수 없는 경우에는 서비스 제공에 관한 책임이 면제됩니다.
            <br />
            3. 수정과는 이용자의 귀책 사유로 인한 서비스 이용의 장애에 대하여는 책임을 지지 않습니다.
            <br />
        ...
        <div>
          ...
          <p>
            ...
            <br />
            2. 사용자는 변경된 약관을 거부할 권리가 있습니다. 만약 7일 이내에 거부 의사를 표시하지 않는 경우에는
            동의하는 것으로 간주합니다.
            <br />
